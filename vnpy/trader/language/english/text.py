...
VOLUME = 'Volume'
VOLUME_DETAIL= u'Order/Trade'
OPEN_INTEREST = 'Open Interest'
OPEN_PRICE = 'Open'
HIGH_PRICE = 'High'
LOW_PRICE = 'Low'
LOCK_POSITION = u'Lock Position'
DEFAULT_OPEN = u'Default Open'
TIME = 'Time'
GATEWAY = 'Gateway'
CONTENT = 'Content'
...
OFFSET = u'Offset'
PROFIT_SIZE = u'Profit Size'
PRICE = u'Price'
BOOK_PRICE = u'Book Price'
CLOSE_BOOK_PRICE = u'Close Price'
LIMIT_PRICE = u'Limit Price'
...
#POSITION = u'Position'
TD_POSITION_LONG = u'Today Long'
TD_POSITION_SHORT = u'Today Short'
POSITION_LONG_PROFIT = u'Long Profit'
POSITION_SHORT_PROFIT = u'Short Profit'
YD_POSITION = u'Yesterday Position'
YD_POSITION_LONG = u'Yesterday Long'
YD_POSITION_SHORT = u'Yesterday Short'
FROZEN = u'Frozen'
POSITION_PROFIT = u'Position Profit'

ACCOUNT_ID = u'Account ID'
TOTAL_PROFIT = u'Total Profit'
